                    ...
                    <div class="container-login100" style="background: none;">
                        <div class="wrap-register100">
                            <form class="login100-form validate-form" method="post" enctype="multipart/form-data">
                                <span class="login100-form-title p-b-10">Electric category</span>
                                <div class="row">
                                    <div class="col-6" style="margin-top:10px;">
                                        <center>
                                            <span style="font-size: 16px;font-weight: bold;">
                                                <img src="electriciansimg/fan.jpg" width="100" height="100" ><br><br>
                                                Price: 200
                                                <br>
                                                <input type="checkbox" name="category[]" value="Fan:200">&nbsp;&nbsp;Fan
                                            </span>
                                            <div class="validate-input" style="margin-top: 30px;" data-validate="Valid name is: a@b.c">
                                                <span style="font-size: 16px;font-weight: bold;">
                                                    <img src="electriciansimg/MCB & fusse.jpg" width="100" height="100" ><br><br>
                                                     Price: 250
                                                     <br>
                                                    <input type="checkbox" name="category[]" value="MCB & fusse:250">&nbsp;&nbsp; MCB & fusse
                                                </span>
                                            </div>
                                        </center>
                                    </div>
                                    <div class="col-6" style="margin-top:10px">
                                        <center>
                                            <span style="font-size: 16px;font-weight: bold;">
                                                <img src="electriciansimg/socket.jpg" width="100" height="100" ><br><br>
                                                 Price: 200
                                                <br>
                                                <input type="checkbox" name="category[]" value="Switch & Socket:200">&nbsp;&nbsp;Switch & Socket
                                            </span>
                                            <div class="validate-input" style="margin-top: 30px;" data-validate="Valid name is: a@b.c">
                                                <span style="font-size: 16px;font-weight: bold;">
                                                    <img src="electriciansimg/wiring.jpg" width="100" height="100" ><br><br>
                                                     Price: 400
                                                <br>
                                                    <input type="checkbox" name="category[]" value="Wiring:400">&nbsp;&nbsp; Wiring
                                                </span>
                                            </div>
                                        </center>
                                    </div>
                            ...
                            if (isset($_POST['submit'])) {
                                if (!empty($_POST['category'])) {
                                   $selected_categories = $_POST['category'];
                                    ...
                                    $_SESSION['categoryname'] = "Electric";
