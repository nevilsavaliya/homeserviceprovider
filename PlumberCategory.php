                    ...
                    <div class="container-login100" style="background: none;">
                        <div class="wrap-register100">
                            <form class="login100-form validate-form" method="post" enctype="multipart/form-data">
                                <span class="login100-form-title p-b-10">Plumber category</span>
                                <div class="row">
                                    <div class="col-6" style="margin-top:10px;">
                                        <center>
                                            <span style="font-size: 16px;font-weight: bold;">
                                                <img src="plumberimg/basin.jpg" width="100" height="100"><br><br>
                                                Price: 200
                                                <br>
                                                <input type="checkbox" name="category[]" value="Basin & sink:200">&nbsp;&nbsp;Basin & sink
                                            </span>
                                            <div class="validate-input" style="margin-top: 30px;" data-validate="Valid name is: a@b.c">
                                                <span style="font-size: 16px;font-weight: bold;">
                                                    <img src="plumberimg/bath fitting.jpg" width="100" height="100"><br><br>
                                                    Price: 250
                                                    <br>
                                                    <input type="checkbox" name="category[]" value="Bath fitting:250">&nbsp;&nbsp; Bath fitting
                                                </span>
                                            </div>
                                        </center>
                                    </div>
                                    <div class="col-6" style="margin-top:10px">
                                        <center>
                                            <span style="font-size: 16px;font-weight: bold;">
                                                <img src="plumberimg/tap.jpg" width="100" height="100"><br><br>
                                                Price:300
                                                <br>
                                                <input type="checkbox" name="category[]" value="Tap & Mixer:300">&nbsp;&nbsp;Tap & Mixer
                                            </span>
                                            <div class="validate-input" style="margin-top: 30px;" data-validate="Valid name is: a@b.c">
                                                <span style="font-size: 16px;font-weight: bold;">
                                                    <img src="plumberimg/connection.jpg" width="100" height="100" ><br><br>
                                                    Price:400
                                                    <br>
                                                    <input type="checkbox" name="category[]" value="Water pipe connections:400">&nbsp;&nbsp; Water pipe connections
                                                </span>
                                            </div>
                                        </center>
                                    </div>
