                        ...
                        <div class="wrap-register100">
                            <form class="login100-form validate-form" method="post">
                                ...
                                <div class="row">
                                    <div class="col-6" style="margin-top:30px">
                                        ...
                                        <div class="wrap-input100 validate-input" data-validate="Valid contact is: a@b.c">
                                            <input class="input100" type="text" name="contact" id="MobileNo" maxlength="10" >
                                        ...
                                        <div class="wrap-input100 validate-input" data-validate="Valid Aadharcard number is: a@b.c">
                                            <input class="input100 Aadharcard" id="Aadharcard" type="text" name="AadharcardNumber">
                                            <span class="focus-input100" data-placeholder="Aadharcard Number"></span>
                                        </div>
                                        <script>
                                            $(document).ready(function () {
                                        ...
                                        <div  data-validate="Valid address is: a@b.c" > 
                                        ...
                                        <div  data-validate="Valid address is: a@b.c">
                                            ...
                                            <input  type="file" class="input100" name="serviceproviderphoto" > 
                                        </div>
                                ...
                                <div class="text-center p-t-115">
                                    ...
                                    <a class="txt2" href="Servicelogin.php">
                                        Sign In
                                    </a>
                                </div>
                            </form>
                            ...
                            if (isset($_POST['submit'])) {
                                ...
                                if ($pass == $cpass) {
                                    ...
                                    $sql = "INSERT INTO `service_provider`(`SerProv_Name`, `SerProv_Email`, `SerProv_ContactNo`, `SerProv_Address`, `Gender`, `AadharNumber`, `password`, `Skills`) "
                                            . "VALUES ('$name','$email','$contact','$address','$gender','$aadhar','$pass','$skill')";
                                    echo $sql;
                                    $conn->query($sql);
                                    echo '<script>window.location.href = "Servicelogin.php"</script>';
                                } else {
